...
BLOG_AUTHOR = "Antonio Ercole De Luca (eracle)"  # (translatable)
BLOG_TITLE = "Thoughts and Stuff"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://eracle.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://eracle.github.io/"
BLOG_EMAIL = "eracle@posteo.eu"
BLOG_DESCRIPTION = "Antonio Ercole De Luca Page"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/posts/me.html', 'About me', 'icon-user'),
        ('http://www.linkedin.com/pub/antonio-ercole-de-luca/1b/340/197', 'Linkedin', 'icon-linkedin-sign'),
        ('https://github.com/eracle', 'My Github', 'icon-github'),
    )
}
